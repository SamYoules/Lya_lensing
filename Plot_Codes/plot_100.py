...
#Clxx = '2.0-1000/Maps/Cls/cross/Cls_crossed_with_input.txt'
#Cla = '2.0-1000/Maps/Cls/auto/Cls.txt'
#Clax = '2.0-1000/Maps/Cls/auto/Cls_crossed_with_input.txt'
#Clc = '2.0-1000/Maps/Cls/combined/Cls.txt'
#Clcx = '2.0-1000/Maps/Cls/combined/Cls_crossed_with_input.txt'
...
P.errorbar(ell, cross_mean[0]*ell, xerr=None, yerr=cross_stdev[0]*ell,
       ...
       label='Auto x Input'.format(maptype))
P.errorbar(ell + 4, cross_mean[1]*ell, xerr=None, yerr=cross_stdev[1]*ell,
       ...
       label='Cross x Input'.format(maptype))
P.errorbar(ell + 8, cross_mean[2]*ell, xerr=None, yerr=cross_stdev[2]*ell,
       ...
       label='Combined x Input'.format(maptype))

props = dict(boxstyle='round', facecolor='white', alpha=0.5)

# place a text box in upper left in axes coords
ax.text(0.4, 0.95, chi2new, transform=ax.transAxes, fontsize=10,
        verticalalignment='top', bbox=props)

P.axhline(0., color='k', ls=':')
P.ylabel(r'$\ell \ C_{\ell}^{\rm{true, est}}$', fontsize=16)
P.xlabel(r'$\ell$', fontsize=16)
P.xlim([0, 800])
P.ylim([-1.1e-6, 1.1e-6])
...
P.tight_layout()
P.savefig('2.0-1000/Plots/cls_100.pdf')
P.savefig('2.0-1000/Plots/cls_100.png')
