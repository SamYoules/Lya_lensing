...
if __name__=='__main__':
    ...
    if cross:
        ra1, dec1 = get_radec(drq['THING_ID'].data, drq['RA'].data,
                    drq['DEC'].data, kap.get('THIDQ'))
        ra2, dec2 = get_radec(drq['THING_ID'].data, drq['RA'].data,
                    drq['DEC'].data, kap.get('THID'))
    else:
        ra1, dec1 = get_radec(drq['THING_ID'].data, drq['RA'].data,
                    drq['DEC'].data, kap.get('THID1'))
        ra2, dec2 = get_radec(drq['THING_ID'].data, drq['RA'].data,
                    drq['DEC'].data, kap.get('THID2'))

    skappa = kap.get('SKAPPA')
    wkappa = kap.get('WKAPPA')
